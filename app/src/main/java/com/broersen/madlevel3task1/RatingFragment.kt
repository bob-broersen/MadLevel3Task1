package com.broersen.madlevel3task1
...
class RatingFragment : Fragment() {
    ...
    private fun navigateToSummary() {
        ...
        args.putString(ARG_GAME_NAME, tvRateSecond.text.toString())

        findNavController().navigate(R.id.action_ratingFragment_to_summaryFragment, args)
    }

    private fun showRandomGame(){
        val game = listOf<String>("Red Dead Redemption 2", "Rocket League",
            "Shadow of the Tombraider").random()

        tvRateSecond.text = game;
    }
}